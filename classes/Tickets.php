...
class Tickets extends Database {  
	...
	private $departmentsTable = 'tb_departments';
	...
	public function showTickets(){
		...
		$time = new time;  			 
		$sqlQuery = "SELECT t.id, t.uniqid, t.title, t.init_msg as message, t.date, t.last_reply, t.resolved, u.fname as creater, d.dname as department, u.user_type, t.user, t.user_read, t.admin_read
			FROM hd_tickets t 
			LEFT JOIN tb_users u ON t.user = u.sid 
			LEFT JOIN tb_departments d ON t.department = d.department_id $sqlWhere ";
		if(!empty($_POST["search"]["value"])){
